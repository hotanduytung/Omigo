      ...
      <div className="footer-grid">
        <div style={styles.colBrand}>
          ...
          <div style={styles.socials}>
            ...
            <a href="https://zalo.me/0868801601" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '32px', height: '32px', padding: 0, border: 'none', background: 'none' }} title="Zalo">
